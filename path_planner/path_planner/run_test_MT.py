...
class StartTestService(Node):
    def __init__(self):
        ...
        self.test_MT_info_pub = self.create_publisher(
            String,
            "/hw_test/info",
            10
        )
    ...
    def start_bag_recording(self):
        ...
        if self.test_ego:
            ...
            bag_name = f"{self.bag_output_dir}/comb_bag_{self.trajectory_name}_{timestamp}"
    ...
    def odom_callback(self, msg: Odometry):
        ...
        if goal_reached:
            ...
            info_msg = String()
            info_msg.data = "Goal Reached! Stopping the test."
            self.test_MT_info_pub.publish(info_msg)

            # self.stop_bag_recording() TODO see how to record bags
            self.stop_ego_waypoint_updates()
    ...
    def handle_start_test(self, request, response):
        ...
        self.test_MT_info_pub.publish(msg_info)
        ...
        # time.sleep(5.0) # TODO see if necessary

        # if not self.start_bag_recording(): TODO check how to record bags
        #     response.success = False
    ...
    def destroy_node(self):
        ...
        self.stop_ego_waypoint_updates()
        # self.stop_bag_recording() # TODO check how to record bags
        super().destroy_node()
