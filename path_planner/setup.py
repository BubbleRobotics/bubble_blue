...
setup(
    ...
    ('share/path_planner/launch', [
      ...
      'launch/seabed_scan_forward_only_compass.launch.py',
      'launch/seabed_scan_zigzag_forward_only.launch.py',
      'launch/seabed_scan_zigzag_forward_only_compass.launch.py',
    ...
    ('share/path_planner/config', [
      ...
      'config/seabed_scan_zigzag_forward_only.yaml',
      'config/seabed_scan_forward_only_compass.yaml',
      'config/seabed_scan_zigzag_forward_only_compass.yaml',
    ]),
    ],
    ...
    'console_scripts': [
        ...
        'seabed_scan_planner_zig_zag_forward_only = path_planner.seabed_scan_planner_zig_zag_forward_only:main',
